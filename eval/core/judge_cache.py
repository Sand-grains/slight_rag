...
用法示例::
    ...
    from eval.core.judge_cache import _cache_judge_key, _cache_generator_key, get_judge_cache, set_judge_cache
...
def set_judge_cache(cache_key: str, result: "JudgeResult"):
    """将 JudgeResult 写入缓存。"""
    cache = get_cache()
